...
export interface ApiArtikkelArtikkel extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    >;
    publishedAt: Schema.Attribute.DateTime;
    slug: Schema.Attribute.UID<'tittel'> & Schema.Attribute.Required;
...
export interface ApiEksempelEksempel extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    beskrivelse: Schema.Attribute.Blocks;
    ...
    >;
    organisasjon: Schema.Attribute.String;
    publishedAt: Schema.Attribute.DateTime;
    resultater: Schema.Attribute.Text;
    slug: Schema.Attribute.UID<'tittel'> & Schema.Attribute.Required;
    status: Schema.Attribute.Enumeration<
      ['i_utvikling', 'pilot', 'i_drift', 'avsluttet']
    > &
      Schema.Attribute.DefaultTo<'i_utvikling'>;
    tittel: Schema.Attribute.String & Schema.Attribute.Required;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    verktoy: Schema.Attribute.JSON;
  };
}
...
export interface ApiFaqFaq extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    kategori: Schema.Attribute.Relation<
      'manyToOne',
      'api::merkelapp.merkelapp'
    >;
    locale: Schema.Attribute.String;
    ...
    publishedAt: Schema.Attribute.DateTime;
    rekkefølge: Schema.Attribute.Integer & Schema.Attribute.DefaultTo<0>;
...
export interface ApiMerkelappMerkelapp extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    eksempler: Schema.Attribute.Relation<
      'manyToMany',
      'api::eksempel.eksempel'
    >;
    ...
    localizations: Schema.Attribute.Relation<
      ...
      'api::merkelapp.merkelapp'
    >;
    navn: Schema.Attribute.String & Schema.Attribute.Required;
    publishedAt: Schema.Attribute.DateTime;
    slug: Schema.Attribute.UID<'navn'> & Schema.Attribute.Required;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    veiledninger: Schema.Attribute.Relation<
      'oneToMany',
...
export interface ApiSideSide extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    innhold: Schema.Attribute.Blocks;
    locale: Schema.Attribute.String;
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::side.side'>;
    publishedAt: Schema.Attribute.DateTime;
    seoBeskrivelse: Schema.Attribute.Text;
    seoTittel: Schema.Attribute.String;
    slug: Schema.Attribute.UID<'tittel'> & Schema.Attribute.Required;
    template: Schema.Attribute.Enumeration<
      ['standard', 'bred', 'landingsside']
    > &
...
export interface ApiVeiledningVeiledning extends Struct.CollectionTypeSchema {
