...
tidligere praksis, eller kvalitetssikre dokumenter.</p>");
    ...
    private void SeedOrdbokOppslag(int parentId)
    {
        var terms = new[]
        {
            ...
            ("Datasporbarhet", "Data lineage", "Data lineage beskriver hvor data kommer fra, hvordan de er behandlet underveis og hvor de brukes, slik at du kan spore og forstå hele «reisen» til dataene."),
            ("Datasporbarhet", "data lineage", "Datasporbarhet beskriver hvor data kommer fra, hvordan de er behandlet og hvor de brukes, slik at man kan oppdage feil og vurdere risiko."),
            ...
            ("PilotprosjektE", "", "t pilotprosjekt er en test av KI-løsningen i en begrenset del av virksomheten med ekte brukere og data."),
