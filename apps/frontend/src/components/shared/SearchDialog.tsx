...
const DUMMY_RESULT: Record<string, DummyData> = {
  'kunstig intelligens': {
    ...
    results: [
      ...
      { title: 'KI-chatbot for innbyggerdialog', path: '/eksempler/ki-chatbot', excerpt: 'Kommune X bruker generativ KI til å besvare innbyggerhenvendelser 24/7.', type: 'Eksempel' },
        ...
        <div className="search-dialog-content" role="dialog" aria-modal="true" aria-labelledby="search-dialog-title">
          ...
          <div className="search-dialog-header">
            <Heading level={2} data-size="xs" id="search-dialog-title" className="search-dialog-title">
              Hva leter du etter eller lurer du på?
            </Heading>
          ...
          <div className="search-dialog-scroll">
            ...
            {hasResults && (
              <>
                {/* Search results first (as per UX spec) */}
                ...
                <section className="search-ai-overview" aria-label="KI-oversikt">
                  ...
                  {!aiExpanded && (
                    <button type="button" className="search-ai-expand" onClick={() => setAiExpanded(true)}>
                      Vis mer
                  ...
                  {aiExpanded && (
                    <button type="button" className="search-ai-expand" onClick={() => setAiExpanded(false)}>
                      Vis mindre
